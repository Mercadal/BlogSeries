...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '8889', 'dbname' => 'symfony', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'serverVersion' => '5.6.1', 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/article/PlatformBundle/Entity'))), 'article\\PlatformBundle\\Entity');
        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('articlePlatformBundle' => 'article\\PlatformBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ac28e872a50568374d1f438a25044b9a5bb4d569562c042a3ecc47b10fb64bcc');
        return $instance;
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/article/PlatformBundle/Resources/views'), 'articlePlatform');
        $instance->addPath(($this->targetDirs[3].'/src/Guillaume/BlogBundle/Resources/views'), 'GuillaumeBlog');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('662f09c764df0099d70b12ba6ef46c0e5a32b8a3');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('565c2fff588684.22961407')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'articlePlatformBundle' => 'article\\PlatformBundle\\articlePlatformBundle',
                'GuillaumeBlogBundle' => 'Guillaume\\BlogBundle\\GuillaumeBlogBundle',
            ),
            ...
            'secret' => '662f09c764df0099d70b12ba6ef46c0e5a32b8a3',
            'locale' => 'en',
            ...
            'kernel.secret' => '662f09c764df0099d70b12ba6ef46c0e5a32b8a3',
